...
def main(
    ...
    shutil.copyfile(base_model + "/utils.py", os.path.abspath(sys.modules[utils.__name__].__file__), follow_symlinks=True)
    ...
    acc = 0
    nop = 0
    file = open('/root/autodl-tmp/data/Triviaqa/wikipedia2.json', 'r', encoding='utf-8')
