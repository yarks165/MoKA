...
def main(
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        for i, detail in enumerate(sample_details):
            ...
            f.write(f"predict: {detail['prediction']}\n")
            f.write(f"truth: {detail['answer']}\n")
            f.write(f"is_correct: {'True' if detail['is_correct'] else 'False'}\n\n")
    
    print(f"File is Saved at ：{output_file}")
